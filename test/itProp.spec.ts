import { itProp, fc } from "../lib/jest-fast-check";
...
describe("itProp", () => {
  ...
  itProp(
    "should pass on truthy synchronous property",
  ...
  itProp(
    "should pass on truthy asynchronous property",
    [fc.nat(), fc.string()],
    async (a, b) => {
      await delay(0);
  ...
  itProp(
    'should fail with seed=4242 and path="25"',
    [fc.constant(null)],
    _unused => false,
    { seed: 4242, path: "25" }
  );
